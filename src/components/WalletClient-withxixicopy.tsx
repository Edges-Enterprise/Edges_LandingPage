...
export function WalletClient({
  ...
  const [hasVirtualAccount] = useState(
    (initialVirtualAccounts || []).length > 0
  );
  ...
  const [formData, setFormData] = useState({
    ...
    bvn: "",
    nin: "",
    provider: "auto" as "xixapay" | "payvessel" | "auto",
  });
              ...
              <form onSubmit={handleCreateAccount} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full h-12 px-4 bg-gray-900 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#D7A77F]"
                    disabled={isPending}
                  >
                    <option value="auto">Auto (Try XixaPay, then PayVessel)</option>
                    <option value="xixapay">XixaPay (Palmpay, KOLOMONI, Safehaven)</option>
                    <option value="payvessel">PayVessel (PalmPay, 9Payment)</option>
                  </select>
                  <p className="text-gray-500 text-xs mt-1">
                    Auto mode will try both providers for best results
                  </p>
                </div>
                ...
                <div className="bg-[#744925]/10 border border-[#744925]/30 rounded-lg p-4 mt-4">
                  ...
                  <p className="text-gray-300 text-xs leading-relaxed mb-2">
                    ⚠️ We use your information only to create your virtual account
                    with our banking partners.
                  </p>
                  <div className="text-gray-300 text-xs leading-relaxed">
                    <strong className="text-[#D7A77F]">XixaPay Banks:</strong>{" "}
                    <span className="text-purple-500">Palmpay</span>,{" "}
                    <span className="text-blue-500">KOLOMONI MFB</span>,{" "}
                    <span className="text-green-500">Safehaven</span>
                  </div>
                  <div className="text-gray-300 text-xs leading-relaxed mt-1">
                    <strong className="text-[#D7A77F]">PayVessel Banks:</strong>{" "}
                    <span className="text-purple-500">PalmPay</span>,{" "}
                    <span className="text-blue-500">9Payment Service Bank</span>
                  </div>
                </div>
              </form>
            </div>
...
//                     We use your information only to create your virtual account
//                     with our banking partners (
