// src/components/reseller/country/CountryHowItWorks.tsx
"use client";

import { UserPlus, Wallet, PencilLine, Store } from "lucide-react";
import { CountryConfig } from "@/config/countries";

interface CountryHowItWorksProps {
  config: CountryConfig;
  translations: any;
}

export default function CountryHowItWorks({
  config,
  translations,
}: CountryHowItWorksProps) {
  ...
  const icons = [UserPlus, Store, PencilLine, Wallet];
