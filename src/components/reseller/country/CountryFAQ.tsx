// src/components/reseller/country/CountryFAQ.tsx
"use client";
...
export default function CountryFAQ({ config, translations }: CountryFAQProps) {
  ...
  const faqs = t?.faq?.items || [
    ...
    },
    {
      ...
      a: `If you want your own mobile app, select the Android APK option during signup. We'll build a custom-branded app for your store and send the download link to your email within ${config.stats.apkDeliveryDays} business days.`,
    },
    {
      q: "Which networks and products can I sell?",
      a: "Your store covers all major networks in your country for data bundles and airtime top-ups. New products are added to the catalog regularly.",
    },
    {
