...
export const korapay: PaymentGateway = {
  ...
  //     // ✅ Check if we should use Direct API or Checkout Redirect
  //     if (USE_DIRECT_API && mobileMoney?.number) {
  //       // ============================================
  //       // DIRECT API FLOW - Requires Mobile Money API access
  //       // ============================================
  //       console.log("📤 Using Korapay Direct API flow");
  ...
  //       const url = `${KORAPAY_BASE_URL}/charges/mobile-money`;
  //       console.log("📤 Korapay Direct API Request URL:", url);
  //       console.log(
  //         "📤 Korapay Direct API Payload:",
  ...
  //           ) {
  //             console.error("❌ Korapay returned HTML instead of JSON");
  //             return {
  //               success: false,
  //               reference,
  //               error:
  //                 "Payment service unavailable. Please check your API credentials.",
  //             };
  //           }
  //           throw new Error(
  ...
  //         console.log("📥 Korapay Direct API Response:", data);

  //         if (data.code === "AA001" || data.data?.auth_model) {
  ...
  //           // If Direct API fails with "not permitted" error, fallback to Checkout Redirect
  //           if (data.message?.includes("not permitted")) {
  //             console.log(
  //               "⚠️ Direct API not permitted, falling back to Checkout Redirect",
  //             );
  //             // Continue to Checkout Redirect flow below
  //           } else {
  //             return {
  //               success: false,
  //               reference,
  ...
  //         }
  //       } catch (fetchError) {
  //         console.error("❌ Korapay fetch error:", fetchError);
  //         return {
  //           success: false,
  //           reference,
  //           error:
  ...
  //     // ============================================
  //     // CHECKOUT REDIRECT FLOW - Always works
  //     // ============================================
  //     console.log("📤 Using Korapay Checkout Redirect flow");
  ...
  //     const url = `${KORAPAY_BASE_URL}/charges/initialize`;
  //     console.log("📤 Korapay Checkout Redirect URL:", url);
  //     console.log(
  //       "📤 Korapay Checkout Redirect Payload:",
  //       JSON.stringify(payload, null, 2),
  //     );
  ...
  //       console.log("📥 Korapay Checkout Redirect Response:", data);
  ...
  // src/lib/payments/korapay.ts - The initiatePayment function for Checkout Redirect
...
// // ✅ Feature flag - toggle this when API access is granted
// // Change to true when Mobile Money API is enabled
// export const USE_DIRECT_API = false; // ✅ Only export here
...
// function formatPhoneNumberForKorapay(phoneNumber: string): string {
//   // Remove any non-digit characters
//   let cleaned = phoneNumber.replace(/\D/g, "");

//   // If number doesn't start with country code, add it for Ghana (233)
...
//    * - Uses Direct API if enabled (USE_DIRECT_API = true)
//    * - Uses Checkout Redirect as fallback (USE_DIRECT_API = false)
//    */
//   async initiatePayment(
//     params: PaymentInitiateParams,
//   ): Promise<PaymentInitiateResult> {
...
//         const formattedNumber = formatPhoneNumberForKorapay(mobileMoney.number);
...
//         console.log("📤 Korapay Direct API Request:", {
//           url: `${KORAPAY_BASE_URL}/charges/mobile-money`,
//           payload: {
//             ...payload,
//             mobile_money: {
//               number: payload.mobile_money.number.replace(/\d/g, "*"),
//             },
//           },
//         });
...
//   getMobileMoneyNetworks(countryCode: string): string[] {
//     // For checkout redirect, we don't need to return networks
//     return [];
//   },
...
// // ✅ No duplicate export here - USE_DIRECT_API is already exported above
// // The line below was causing the error, so it's removed
// // export { USE_DIRECT_API };
