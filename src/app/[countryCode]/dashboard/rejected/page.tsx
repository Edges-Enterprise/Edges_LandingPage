// src/app/[countryCode]/dashboard/rejected/page.tsx
"use client";
...
export default function RejectedPage({ params }: RejectedPageProps) {
    ...
    <div className="max-w-2xl mx-auto py-12 px-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-6">
          We regret to inform you that your application could not be approved at
          this time.
        </p>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our support team can provide more information about the
                  decision.
                </p>
              </div>
            </div>
        ...
        {/* Actions */}
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row gap-3">
          <button
            onClick={handleReapply}
            className="flex-1 px-6 py-2.5 bg-primary text-white rounded-lg font-medium hover:bg-primary/80 transition-colors"
          >
            Submit New Application
          </button>
          <button
            onClick={() => (window.location.href = `/${countryCode}/support`)}
            className="flex-1 px-6 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
          >
            Contact Support
          </button>
        </div>
