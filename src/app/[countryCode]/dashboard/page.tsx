...
// the page component below share one auth check + one RPC call instead
// of firing it twice.
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const iconUrl = dashboardData?.logo_url || DEFAULT_ICON;

  return {
    title: `${storeName} Dashboard`,
    icons: {
      icon: [{ url: iconUrl, sizes: "32x32", type: "image/png" }],
      shortcut: iconUrl,
      apple: iconUrl,
    },
  };
