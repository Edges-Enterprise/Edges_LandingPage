...
//       user_id: user.id,
//       notification_type: "data_purchase",
//       message: `Successfully purchased ${lizzysubData.dataplan} for ${formData.phone}`,
//       is_read: false,
//       metadata: {
//         network: lizzysubData.network,
//         phone: formData.phone,
...
// //  * Fetch Hot Deals from Supabase
// //  */
// // export async function getHotDealsAction(networkId: number) {
// //   try {
// //     const supabase = await createServerClient();
...
// //  * Fetch Data Plans from Lizzysub Table
// //  */
// // export async function getDataPlansAction(networkId: number, category?: string) {
// //   try {
// //     const supabase = await createServerClient();

// //     let query = supabase.from("lizzy").select("*").eq("network_id", networkId);

// //     // Filter by category if provided
// //     if (category && category !== "Hot") {
// //       if (category === "Daily Plans") {
// //         query = query.eq("validity_days", 1);
// //       } else if (category === "Weekly Plans") {
// //         query = query.eq("validity_days", 7);
// //       } else if (category === "Monthly Plans") {
// //         query = query.gte("validity_days", 30);
// //       }
// //     }
