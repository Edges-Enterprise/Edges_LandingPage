    ...
    <div style={{ minHeight: '100vh', background: '#F9FAFB', fontFamily: "'Instrument Sans', system-ui, sans-serif" }}>
      ...
      <main style={{ maxWidth: 1100, margin: '0 auto', padding: '1.5rem' }}>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            >
              {featuredPlans.map((plan) => (
                ...
                >
                  <p style={{ fontWeight: 600, color: '#111827', fontSize: '0.95rem', marginBottom: 4 }}>
                    {plan.name}
                  </p>
                  {plan.validity && (
                  ...
                  <p style={{ fontSize: '1.5rem', fontWeight: 700, color: colors.primary, marginBottom: 12 }}>
        ...
        >
          ...
          <p style={{ opacity: 0.9, fontSize: '0.9rem', marginBottom: '1.25rem' }}>
      ...
      >
        <p>Powered by Edges Network • {displayName} Store</p>
      </footer>
    </div>
  )
}
