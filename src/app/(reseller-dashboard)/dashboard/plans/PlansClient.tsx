...
//   const handleBulkUpdate = async () => {
//     setBulkSaving(true);
//     // Bulk update only plans in the current network tab
//     const networkPlanIds = plans.map((p) => p.id);

//     // Update each plan individually since bulkUpdateAllPlans updates ALL plans
//     for (const planId of networkPlanIds) {
//       await updateResellerPlan(resellerId, {
//         resellerPlanId: planId,
//         markup_type: bulkType,
...
//           }}
//         >
//           Bulk Update All {activeTab} Plans
//         </h3>
//         <div
//           style={{
//             display: "flex",
...
//             rp.markup_value,
//           );
//           const profit = finalPrice - rp.plan!.amount;
