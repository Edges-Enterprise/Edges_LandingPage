// app/(reseller-dashboard)/orders/OrdersClient.tsx
...
export function OrdersClient({ orders }: { orders: Order[] }) {
  ...
  const getPlanBadge = (plan: Order["plan"]) => {
    const isAirtime = plan?.plan_type?.toLowerCase() === "airtime" || plan?.plan_name?.toLowerCase().includes("airtime");
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      <Card padding="none">
        ...
        >
          <h2 style={{ fontWeight: 600, color: "var(--text)", fontSize: "1rem" }}>
            All Orders
          </h2>
        </div>
        {orders.length === 0 ? (
          <div style={{ padding: "3rem", textAlign: "center", color: "var(--dim)" }}>
            ...
            <p style={{ fontSize: "1rem", marginBottom: "0.25rem" }}>No orders yet</p>
            <p style={{ fontSize: "0.85rem" }}>Share your store link to start receiving orders</p>
          </div>
        ) : (
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              ...
              <tbody>
                {orders.map((order) => {
                  const badge = getPlanBadge(order.plan);
                  ...
                  return (
                    <tr key={order.id} style={{ borderBottom: "1px solid var(--border)" }}>
                      ...
                      <td style={tdStyle}>
                        ...
                        >
                          {badge.icon} {order.plan?.plan_name || "—"}
                        </span>
                      </td>
                      ...
                      <td style={{ ...tdStyle, color: "var(--dim)", fontSize: "0.8rem" }}>
