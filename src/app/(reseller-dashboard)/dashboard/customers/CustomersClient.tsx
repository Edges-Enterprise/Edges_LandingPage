// app/(reseller-dashboard)/dashboard/customers/CustomersClient.tsx
      ...
      <Card padding="none">
        {customers.length === 0 ? (
          <div style={{ padding: '3rem', textAlign: 'center', color: 'var(--dim)' }}>
            ...
            <p style={{ fontSize: '1rem', marginBottom: '0.25rem' }}>No customers yet</p>
                  ...
                  >
                    <td style={tdStyle}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        ...
                        <div>
                          <p style={{ fontWeight: 500, color: 'var(--text)', fontSize: '0.9rem' }}>
                            {customer.email}
                          </p>
                    ...
                    <td style={{ ...tdStyle, color: 'var(--dim)', fontSize: '0.82rem' }}>
                      {customer.last_order
                        ? new Date(customer.last_order).toLocaleDateString('en-NG', {
                            month: 'short',
                            day: 'numeric',
                            year: 'numeric',
                          })
