  ...
  return (
    <div className="fixed top-4 right-4 z-10 md:top-6 md:right-6">
      ...
      >
        ...
        {count > 0 && (
          <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center min-w-[20px] md:h-6 md:w-6 md:text-sm">
            {count > 99 ? "99+" : count}
          </span>
        )}
      </button>
